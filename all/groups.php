...
?>
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-list"></i> Groups</h2>
	...
	if($group_row["user_role_id"]!=PG)
		continue;
	$guide_row=$admin->getGroupById($group_row["guide_id"]);
	?>
    <tr id="<?php echo $group_row["pg_id"]; ?>">
        ...
        <td class="center">
            ...
            <a class="btn btn-success view_pg" href="#">
                <i class="glyphicon glyphicon-eye-open icon-white"></i>            
            </a>
			<a class="btn btn-info" href="<?php echo getBaseUrl(); ?>add_edit/group.php?id=<?php echo $group_row["pg_id"]; ?>">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<div class="row"><h4>
                    <div class="col-md-4">Group Number</div> <div class="col-md-8">: <?php echo $group_row["group_number"]; ?></div>
					<div class="col-md-4">Guide </div> <div class="col-md-8">: <?php echo $guide_row["group_number"]; ?></div>					
