...
$common=new common();
$project_set=$common->getAllProjects();
?>
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-list"></i> All Projects</h2>
	...
	<?php 
	$i=1;
	while($project_row=$project_set->fetch_assoc()) { 
    ...
    <tr id="<?php echo $project_row["p_id"]; ?>">
        ...
        <td class="center">
            <a class="btn btn-success" href="<?php echo getBaseUrl(); ?>project_details.php?id=
