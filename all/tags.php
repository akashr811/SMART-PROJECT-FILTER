...
?>
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-list"></i> All Tags</h2>
    ...
    <table class="table table-striped table-bordered bootstrap-datatable datatable responsive" id="tags">
    <thead>
    <tr>
        <th>SI No</th>
        <th>Tag Name</th>
	...
	?>
    <tr id="<?php echo $tag_row["id"]; ?>">
        <td><?php echo $i; ?></td>
		<td class="center"><?php echo $tag_row["name"]; ?></td>
        <td class="center">
           
            <a class="btn btn-info" href="<?php echo getBaseUrl(); ?>add_edit/tag.php?id=<?php echo $tag_row["id"]; ?>">
