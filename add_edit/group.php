...
?>
    ...
    <div class="box-content">
		<form class="form_center" method="post">
			...
			<div class="form-group row">
				<label class="control-label col-md-2">Guide</label>
				<div class="col-md-5">
				<select class="form-control" name="guide_id">
				<?php while($guide_row=$guide_set->fetch_assoc()) { 
				$selected="";
				if($guide_row["pg_id"]==$guide_id)
					$selected="selected";
				?>
					<option value="<?php echo $guide_row["pg_id"]; ?>" <?php echo $selected; ?>><?php echo $guide_row["group_number"]; ?></option>
				<?php } ?>
				</select>
				</div>
			</div>
			...
			<div class="form-group row">
				<label class="control-label col-md-2">Member 1</label>
				<div class="col-md-5">
				<input type="text" class="form-control" name="member_1" value="<?php echo $member_1; ?>">
				</div>
			</div>
			<div class="form-group row">
				<label class="control-label col-md-2">Member 2</label>
				<div class="col-md-5">
				<input type="text" class="form-control" name="member_2" value="<?php echo $member_2; ?>">
				</div>
			</div>
			<div class="form-group row">
				<label class="control-label col-md-2">Member 3</label>
				<div class="col-md-5">
				<input type="text" class="form-control" name="member_3" value="<?php echo $member_3; ?>">
				</div>
			</div>
			<div class="form-group row">
				<label class="control-label col-md-2">Member 4</label>
				<div class="col-md-5">
				<input type="text" class="form-control" name="member_4" value="<?php echo $member_4; ?>">
				</div>
			</div>
			<input type="hidden" class="form-control" name="user_role" value="3">
			<div class="form-group row">
			<div class="col-md-5">
				<input type="submit" class="btn btn-primary pull-right" name="<?php echo $sbmt_btn_name; ?>" value="Save Group">
			</div>
			</div>
		</form>
    </div>
